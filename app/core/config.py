...
class Settings(BaseSettings):
    ...
    MEMORY_INDEPENDENT_CLAIM_VERIFIER_ENABLED: bool = False
    ...
    OLLAMA_VERIFIER_BASE_URL: str | None = None
    OLLAMA_VERIFIER_MODELS_URL: str | None = None
    OLLAMA_VERIFIER_MODEL: str | None = None
    OLLAMA_VERIFIER_TIMEOUT_SECONDS: int | None = Field(default=None, gt=0)
